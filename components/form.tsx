      ...
      <Card className="border-0 shadow-none">
        ...
        <CardContent>
          <form action={action} className="mt-3">
            <Input name="prompt" placeholder="What should I write about?" className="rounded-lg" />
            <SubmitButton />
          </form>
        </CardContent>
      </Card>
    ...
    <>
      ...
      <SignedOut>
        <SignInButton mode="modal">
          <Button size="sm" type="button" variant="secondary" className="mt-3 w-full rounded-lg">
            Sign in to start
          </Button>
        </SignInButton>
      </SignedOut>
